<?php
/**
 * Setup ACF Fields for Demarchelier Theme
 * Run this script to create and populate ACF fields
 */
...
if (!class_exists('ACF')) {
    echo "ACF plugin is not active. Please activate Advanced Custom Fields plugin first.\n";
    exit;
}

echo "Setting up ACF fields for Demarchelier theme...\n";
